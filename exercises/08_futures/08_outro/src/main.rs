...
//! content-type: application/json
//! content-length: 1
//! date: Tue, 16 Jul 2024 01:54:49 GMT
//!
//! 0
//!
//! # 2つ目のチケットを登録
//! $ curl --include -H "Content-Type: application/json" -d '{"title": "羅生門", "description": "人間が生きるための利己主義と善悪について描いた作品"}' http://localhost:3000/tickets
//! HTTP/1.1 200 OK
//! content-type: application/json
//! content-length: 1
//! date: Tue, 16 Jul 2024 02:02:50 GMT
//!
//! 1
//!
//! # 1つ目のチケットを取得
...
//!
//! # 2つ目のチケットを取得
//! $ curl --include http://localhost:3000/tickets/1
//! HTTP/1.1 200 OK
//! content-type: application/json
//! content-length: 148
//! date: Tue, 16 Jul 2024 02:04:12 GMT
//!
...
//!
//! # 誤ったバージン番号で2つ目のチケットの状態を`Done`に更新
